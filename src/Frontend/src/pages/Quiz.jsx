    ...
    <div className=''>
      <div className="cards flex flex-col gap-3 sm:flex sm:flex-row sm:flex-wrap sm:gap-5 mb-10">
        {diffCards.map((item, index) => (
            <Link to={item.navigate}><div onClick={() => handleClick(item.navigate)} key={index} className="card p-3 sm:p-5 border border-zinc-500  rounded-lg flex flex-col gap-2 hover:scale-105 hover:shadow-gray-500 shadow-gray-500 shadow-md hover:shadow-lg transition-all duration-300  ">
