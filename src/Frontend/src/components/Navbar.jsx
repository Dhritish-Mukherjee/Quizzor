    ...
    <div>
      <nav className="flex justify-between py-4 px-4">
        ...
        <div className="right-menu flex items-center justify-center gap-3 ">
          {user ? 
            <button className="px-5 py-1 bg-transparent rounded-full border border-neutral-100 hover:text-neutral-300  transition-all duration-300 text-neutral-100 cursor-pointer flex justify-center items-center gap-1 text-sm sm:text-md font-medium">Go to Dashboard <IoIosArrowRoundForward /></button> :   
