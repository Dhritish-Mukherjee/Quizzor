...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className="flex justify-between py-3 px-4 border-b border-gray-600">
        ...
        <div className="right-menu flex items-center justify-center gap-3 ">
          {user ? 
            ...
            <Link to='/login'><button className="px-5 py-1 bg-blue-600 rounded-full text-neutral-100 hover:scale-105 hover:bg-blue-500 transition-all duration-300 cursor-pointer">Sign in</button></Link>
        }
