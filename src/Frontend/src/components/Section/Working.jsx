...
const Working = () => {
  return (
    ...
    className='w-full h-auto flex flex-col items-center bg-neutral-100 text-zinc-800 py-8 sm:py-12 px-8 sm:px-20 gap-10 border-b border-gray-400 pb-5'>
      <motion.h1 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ delay: 0.2, duration: 2 }}

      className=' text-4xl sm:text-6xl text-zinc-800 text-center sm:w-1/2'><span className='text-blue-500'>How Quizzor</span> Brings Your Quiz to Life</motion.h1>
      ...
      className="show-img p-3 sm:p-10 bg-white rounded-lg flex flex-col  sm:flex sm:flex-row justify-center gap-10 sm:gap-30 items-center">
