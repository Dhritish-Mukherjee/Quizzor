...
const Footer = () => {
  return (
    <div className='flex flex-col py-8 sm:py-10  px-8 sm:px-20 w-full h-auto max-h-screen text-white pb-0 '>
      <div className='flex flex-col gap-5 sm:flex sm:flex-row justify-between'>
       <div className="newsletter flex flex-col items-start gap-5 w-full sm:w-1/2 ">
            <h3 className='text-2xl sm:text-3xl font-light'>Subscribe to newsletter</h3>
            <div className="email flex justify-center items-center gap-2 sm:gap-5">
              <input type="email" placeholder='your@email.com' className='outline-none border-b border-gray-500 text-lg sm:text-xl focus:border-blue-500 py-2 placeholder:text-lg sm:placeholder:text-xl placeholder:font-light' />
       ...
       <div className="socials flex justify-between items-center gap-30 ">
        <div className="first flex flex-col gap-3  sm:border-l border-gray-600 sm:px-5">
    ...
    <div className="end-footer flex flex-col gap-3 items-start sm:flex sm:flex-row sm:justify-between sm:items-center  py-5">
      <Link to='/' ><div className="logo  px-0 py-0.5 sm:px-5 sm:py-1 rounded-full flex justify-center items-center ">
